...
set_property PACKAGE_PIN R2 [get_ports {switches[8]}]					
...
##7 segment display
set_property PACKAGE_PIN W7 [get_ports {display_data[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {display_data[0]}]
set_property PACKAGE_PIN W6 [get_ports {display_data[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {display_data[1]}]
set_property PACKAGE_PIN U8 [get_ports {display_data[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {display_data[2]}]
set_property PACKAGE_PIN V8 [get_ports {display_data[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {display_data[3]}]
set_property PACKAGE_PIN U5 [get_ports {display_data[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {display_data[4]}]
set_property PACKAGE_PIN V5 [get_ports {display_data[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {display_data[5]}]
set_property PACKAGE_PIN U7 [get_ports {display_data[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {display_data[6]}]

set_property PACKAGE_PIN V7 [get_ports display_data[7]]							
